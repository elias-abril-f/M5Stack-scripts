...
title0 = M5Title(title="Light Sensor", x=3, fgcolor=0xFFFFFF, bgcolor=0x0000FF)
label0 = M5TextBox(115, 100, "Lux", lcd.FONT_DejaVu40, 0xFFFFFF, rotate=0)
...
while True:
    ...
    label0.setText(str(int(bh1750.measurement)))
    sleep_ms(500)
